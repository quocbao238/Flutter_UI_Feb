...
class B_SmartHome_Light extends StatefulWidget {
  @override
  _B_SmartHome_LightState createState() => _B_SmartHome_LightState();
}

class _B_SmartHome_LightState extends State<B_SmartHome_Light> {
  /* Size */
  ...
  /* String name */
  String _name = "Celling\nLight";
  String _colourtemp = "Light Intensity";
  String _softwhite = "Soft White";
  String _nameLight = "Xiaomi Mi LED";
  String _priceLight = "E27 10W 800 Lumen ++";

  double _sliderVar = 50.0;
