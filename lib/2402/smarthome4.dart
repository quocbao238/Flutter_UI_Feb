...
class B_SmartHome_Fan extends StatefulWidget {
  @override
  _B_SmartHome_FanState createState() => _B_SmartHome_FanState();
}

class _B_SmartHome_FanState extends State<B_SmartHome_Fan> {
  /* Size */
  ...
  /* String name */
  String _name = "Ceiling\nFans";
  String _colourtemp = "Fan Speed";
  String _softwhite = "Around";
  String _nameLight = "Xiaomi Smart Fan";
  String _priceLight = "1.8W Engine only 31.5 dB";

  double _sliderVar = 60.0;
